...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(7, 14)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        a = (circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
        b = (circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
